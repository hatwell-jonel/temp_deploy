...
import { subAccountsSearchParams } from "@/validations/searchParams";
...
const title = "Sub Accounts";
const searchPlaceholder = "Sub Accounts";
...
export default function Page({ searchParams }: PageProps) {
  const parsed = subAccountsSearchParams.parse(searchParams);
  return (
    <>
        ...
        <Table className="text-xs">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-center">Sub Accounts</TableHead>
              <TableHead className="text-center">Account Code</TableHead>
          ...
          <TableBody>
            {data.map((d, index) => (
              <TableRow key={d.id} className="odd:bg-[#F9FAFB]">
                ...
                <TableCell className="text-center">{d.accountCode}</TableCell>
