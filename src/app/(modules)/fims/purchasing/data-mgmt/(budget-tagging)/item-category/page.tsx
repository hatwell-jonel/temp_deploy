...
import { itemCategorySearchParams } from "@/validations/searchParams";
...
const searchPlaceholder = "Item Category";
...
export default function Page({ searchParams }: PageProps) {
  const parsed = itemCategorySearchParams.parse(searchParams);
  return (
    <>
      <div className="flex flex-col gap-6 py-8">
        ...
        >
          <Link
            href={"/fims/purchasing/data-mgmt/item-category/create"}
            className={cn(
              ...
              <TableRow key={d.id} className="odd:bg-[#F9FAFB]">
                ...
                <TableCell className="text-center">
                  <div className="flex justify-center gap-2">
                    <Link
                      href={`/fims/purchasing/data-mgmt/item-category/update/${d.id}`}
                    >
                      <Icons.edit />
                    </Link>
