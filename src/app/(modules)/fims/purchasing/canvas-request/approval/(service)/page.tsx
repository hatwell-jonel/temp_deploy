...
const searchPlaceholder = "CRSRn No.";
  ...
  return (
    <>
      <div className="flex flex-col gap-6 py-8">
        ...
        <CanvasRequestTabs userRole="approver" />
        <Suspense>
          <Search
        ...
        <Table className="text-xs">
          <TableHeader className="[&_tr]:border-b-0">
            <TableRow className="[&_th]:h-8">
              <TableHead className="text-center">CRSRn No.</TableHead>
            ...
            {data.map((data) => (
              ...
              >
                <TableCell className="whitespace-nowrap p-1.5 text-center">
                  <Link
                    href={`/fims/purchasing/canvas-request/approval/view/${data.canvasRequestNo}`}
                ...
                <TableCell className="p-1.5 text-center">
                  <div className="flex items-center justify-center">
                    <Link
                      href={`/fims/purchasing/canvas-request/approval/view/${data.canvasRequestNo}?showButtons=false`}
                      title="View"
                    >
                      <Icons.view />
                    </Link>
