import { PrintView } from "@/app/(modules)/fims/purchasing/job-purchase-order/(service)/server";
...
import { jobOrderViewSearchParams } from "@/validations/searchParams";
import { Suspense } from "react";

const title = "View Job Order";
...
export default function Page({ searchParams, params }: PageProps) {
  const parsed = jobOrderViewSearchParams.parse(searchParams);
  return (
    <>
