              ...
              >
                <TableCell className="whitespace-nowrap p-1.5 text-center">
                  {role !== "requester" ? (
                    <Link
                      ...
                      href={`/fims/purchasing/snp-request/purchase/view/${data.requestNo}`}
                    >
                      {data.requestNo}
                    </Link>
                  ) : (
                ...
                <TableCell className="p-1.5 text-center">
                  <div className="flex items-center justify-center">
                    <Link
                      href={`/fims/purchasing/snp-request/purchase/view/${data.requestNo}?showButtons=false`}
                      className="text-xs"
                      title="View"
                    >
                      <Icons.view />
